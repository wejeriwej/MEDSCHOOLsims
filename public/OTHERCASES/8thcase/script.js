...
*/
    ...
    var injuryreal1 = $('#injuryreal1'); var injuryreal2 = $('#injuryreal2'); if (noteContent.includes("injur")||noteContent.includes("hit")||noteContent.includes("bang")||noteContent.includes("fall")){redstyles(injuryreal1); greenstyles(injuryreal2); }
      ...
      if(nameage_repeat == 0 && (noteContent.includes("name") && noteContent.includes("age"))) {
        //readOutLoud("My name is Jake Blamford and I am 25")
        previousquestion = noteContent; nameage_repeat++;   response_question = "I'm Jake and am 25";
        ...
        //readOutLoud("I'm 25 years old")
        previousquestion = noteContent; age_repeat++;   response_question = "I'm 25";
        ...
        previousquestion = noteContent; call_repeat++;  response_question = "Jake is fine";
    ...
    /*  else if (noteContent.includes("age")||noteContent.includes("old")) {
      ...
      */
        ...
        //readOutLoud("the 11th of December 2001");
        previousquestion = noteContent; dob_repeat++;  response_question = "11th of Dec 2001";
        ...
        //readOutLoud("I work as a a part time Health Care Assistant");
        previousquestion = noteContent;   response_question = "I'm a part time HCA";
        ...
        //readOutLoud("The headache comes and goes in waves, and lasts for quite some time and then subsides after a few hours, but then it comes back a few hours later");
        previousquestion = noteContent; alwayspain_repeat++;  response_question = "The headache comes and goes in waves, and lasts for quite some time and then subsides after a few hours, but then it comes back a few hours later";
        timecoursex = true;
        ...
        //readOutLoud("The headache comes and goes in waves, and lasts for quite some time and then subsides after a few hours, but then it comes back a few hours later");
        previousquestion = noteContent; constant_repeat++;  response_question = "The headache comes and goes in waves, and lasts for quite some time and then subsides after a few hours, but then it comes back a few hours later";
        timecoursex = true;
        document.getElementById("mp4_src").src = "videos/painconstantlyalwaysthere.mp4"; allifsaction();}//is the pain always there OR constant (there's another one later too)
  
      else if (painconstant_repeat == 0 && (noteContent.includes("always there")&&noteContent.includes("intermittent"))) {
        //readOutLoud("The headache comes and goes in waves, and lasts for quite some time and then subsides after a few hours, but then it comes back a few hours later");
        previousquestion = noteContent; painconstant_repeat++;  response_question = "The headache comes and goes in waves, and lasts for quite some time and then subsides after a few hours, but then it comes back a few hours later";
        timecoursex = true;
        document.getElementById("mp4_src").src = "videos/painconstantlyalwaysthere.mp4"; allifsaction();}//is the pain always there OR constant (there's another one later too)
  
      else if (intermittent_repeat == 0 && (noteContent.includes("constant")&&noteContent.includes("intermittent"))) {
        //readOutLoud("The headache comes and goes in waves, and lasts for quite some time and then subsides after a few hours, but then it comes back a few hours later");
        previousquestion = noteContent; intermittent_repeat++;  response_question = "The headache comes and goes in waves, and lasts for quite some time and then subsides after a few hours, but then it comes back a few hours later";
        timecoursex = true;
        document.getElementById("mp4_src").src = "videos/painconstantlyalwaysthere.mp4"; allifsaction();}//is the pain always there OR constant (there's another one later too)
        ...
        //readOutLoud("The headache comes and goes in waves, and lasts for quite some time and then subsides after a few hours, but then it comes back a few hours later");
        previousquestion = noteContent; alwaysthere_repeat++;  response_question = "The headache comes and goes in waves, and lasts for quite some time and then subsides after a few hours, but then it comes back a few hours later";
        timecoursex = true;
        ...
        //readOutLoud("The headache comes and goes in waves, and lasts for quite some time and then subsides after a few hours, but then it comes back a few hours later");
        previousquestion = noteContent; comeandgo_repeat++;  response_question = "The headache comes and goes in waves, and lasts for quite some time and then subsides after a few hours, but then it comes back a few hours later";
        timecoursex = true;
      ...
      &&(noteContent.includes("brought")||noteContent.includes("bring")||noteContent.includes("what can")||noteContent.includes("why")
        ...
        //readOutLoud("I've had this really bad headache that keeps coming back and it always lasts for so long and I can't seem to get rid of it. I feel like I can't do anything when I have this headache and I've already needed to take quite a few days off from work. I would say it's really quite severe and when it finally does subside after some time I get so worried of it coming back because it always seems to come back a few days later, so I decided to come into see you to see if we can get to the end of what this is and if it's something serious that I need to worry about.");
        previousquestion = noteContent;   response_question = "I've had bad headache that keeps coming back and can't get rid. I can't do anything when I have it + I've already needed to take time off work. It's severe and when it subsides it feels like it comes back again a few days later, so I wanna get to the end of what this is and if it's something serious";
        painlocationrepeat ++;  
        painlocationx = true;
        onsetx = true;
  ...
  ///////////////////////////////////////////////////////////////////////
        ...
        //readOutLoud("Yesterday I started to get this really bad headache on the right side of my temple and it feels like a really pounding feeling in the side of my head, and is like a throbbing sensation that's just relentless and lasts for hours at a time. I feel like I can't even do anything when I have this pain and I'm just glued in bed and I just can't do anything. I feel bad for my wife because she just has to do everything in the house when I have this headache because it just really knocks me out. I hope you can help me get to the end of this Doctor");
        previousquestion = noteContent; onsetrepeat++;  response_question = "Yesterday I started to get this really bad headache on the right side of my temple and it feels like a really pounding feeling in the side of my head, and is like a throbbing sensation that's just relentless and lasts hours. I feel like I can't even do anything when I have this pain and I'm just glued in bed and I just can't do anything. I feel bad for my wife because she just has to do everything in the house when I have this headache because it just really knocks me out. I hope you can help me get to the end of this Doctor";
        onsetx = true;
  ...
  ////
      ...
      ||noteContent.includes("1-10")||noteContent.includes("1 to 10")||noteContent.includes("one to ten")||noteContent.includes("-10")
        ...
        //readOutLoud("This current headache started last night before going to bed and to be honest I had a horrible night and couldn't deal with it, but I appreciate you giving me an appointment so quickly and seeing me today");
        previousquestion = noteContent; whenstarted_repeat++;  response_question = "This current headache started last night before going to bed and to be honest I had a horrible night and couldn't deal with it, but I appreciate you giving me an appointment so quickly and seeing me today";
        ...
        //readOutLoud("I think the headache has slightly gotten better compared to last night, but it is definitely still there but maybe just not as severe as before");
        previousquestion = noteContent; gottenworsethroughtime_repeat++;  response_question = "I think the headache has slightly gotten better compared to last night, but it is definitely still there but maybe just not as severe as before";
      ...
      else if (pastheart_repeat == 0 && (noteContent.includes("headache")&& noteContent.includes("past")||noteContent.includes("prev"))) {
        //readOutLoud("I have had similar headaches like this in the past, especially in the last year or so. It's always on this right side of my head as well and feels like the same kind of pain each time");
        previousquestion = noteContent; pastheart_repeat++;  response_question = "I have had similar headaches like this in the past, especially in the last year or so. It's always on this right side of my head as well and feels like the same kind of pain each time";
        heartattacksx = true;
      ...
      else if(firstheartattack_repeat == 0 && (noteContent.includes("headache")&& noteContent.includes("first"))){
        //readOutLoud("This is not the first time that I've experienced this kind of headache, I'd even say that I've had it quite often over the last few months but I thought it was just a regular stress headache");
        previousquestion = noteContent; firstheartattack_repeat++;  response_question = "This is not the first time that I've experienced this kind of headache, I'd even say that I've had it quite often over the last few months but I thought it was just a regular stress headache";
        heartattacksx = true;
        document.getElementById("mp4_src").src = "videos/firstheadache.mp4"; allifsaction();}
      ...
      //rule out pain anywhere else
        ...
        //readOutLoud("I have noticed some mild neck pain as well I would say, but it's no way near as severe compared to my temple");
        previousquestion = noteContent; painin_repeat++;  response_question = "I have noticed some mild neck pain as well I would say, but it's no way near as severe compared to my temple";
        radiatex = true;
      ...
      //other symptoms    
        ...
        previousquestion = noteContent; othersymptoms_repeat++;  response_question = "I have noticed that before getting the headache I see these weird lights that flash in my eye sight and I see these zig-zag lines for about half an hour, and that's when I know that I am going to get the headache again";
    ...
    document.getElementById("mp4_src").src = "videos/fever.mp4"; allifsaction();}//do you feel tired all the time/any chills (it eliminates if you say 'do you feel tired of X')
        ...
        //readOutLoud("I haven't vomited this time round with this headache, but I definitely feel very sick and I do have the feeling of vomiting, but I haven't physically been sick.");
      ...
      //SOB   
        ...
        //readOutLoud("When I have the headache come on I can't walk or do any exercise, but when I'm well I normally do a lot of sport. I like to run quite a lot and go maybe twice a week, I've even got a half marathon that I've been training for so I am quite keen on running");
        previousquestion = noteContent; walkdistance_repeat++;  response_question = "When I have the headache come on I can't walk at all or do any exercise, but when I'm well I normally do a lot of sport. I like to run quite a lot and go maybe twice a week, I've even got a half marathon that I've been training for so I am quite keen on running";
        walkdistancex = true;
...
/*
  ...
  */
  ...
  const response = await fetch("https://oscesimstrial1.onrender.com/api/8thcase", {
    method: "POST",
