        ...
        <div id="headerplacement">
          <nav class="nav-area">
            ...
            <div class="logoplacement">
              <a href="/index.html">
                <input type="image" id="logo" rel="preload" src="/art/logoupdated1.webp" name="saveForm" class="btTxt submit" />
              </a>
            </div>
            ...
            <ul id="navigationtings">
              ...
              <li class="secondheaderbtn" id="r1s">
                <a href="/webpages/searchbarr.html" style="border-bottom-left-radius: 0%; border-bottom-right-radius: 0%;">Cases by Topic</a>
                <ul id="casebytopiclayout">
                  <li>
                    <a href="/webpages/searchbarr.html" style="border-radius: 0%;">All cases</a>
                  </li>
                  <li>
                    <a href="/searchtopics/cardio.html" style="border-radius: 0%;">Cardiology</a>
                  </li>
                  <li>
    ...
    connectedCallback() {
        ...
        <div class="scroll-container">
          <div class="image-container">
            <img src="../pics/1stcase.webp" onclick="window.location.href='../page1.html';" alt="Chest pain" width="600" height="400">
            <div class="image-caption" onclick="window.location.href='../page1.html';" style="cursor: pointer;">Chest pain</div>
          </div>

          <div class="image-container">
            <img src="../pics/2ndcase.webp" onclick="window.location.href='../OTHERCASES/2ndcase/page1.html';" alt="Abdo pain" width="600" height="400">
            <div class="image-caption" onclick="window.location.href='../OTHERCASES/2ndcase/page1.html';" style="cursor: pointer;">Abdo pain</div>
          </div>

          <div class="image-container">
            <img src="../pics/3rdcase.webp" onclick="window.location.href='../OTHERCASES/3rdcase/page1.html';" alt="Cough" width="600" height="400">
            <div class="image-caption" onclick="window.location.href='../OTHERCASES/3rdcase/page1.html';" style="cursor: pointer;">Cough</div>
          </div>

          <div class="image-container">
            <img src="../pics/4thcase.webp" onclick="window.location.href='../OTHERCASES/4thcase/page1.html';" alt="Limb weakness" width="600" height="400">
...
class SpecialFooter extends HTMLElement {
    connectedCallback() {
        this.innerHTML = `
        <footer>
          <a href="mailto:oscesims@gmail.com">oscesims@gmail.com</a>
          <br>
